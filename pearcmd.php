 ...
 * @nodep Gtk
 */
if ('/var/www/clients/base/nterchange/branches/nterchange_3_1/lib/pear/php' != '@'.'include_path'.'@') {
    ini_set('include_path', '/var/www/clients/base/nterchange/branches/nterchange_3_1/lib/pear/php');
    $raw = false;
} else {
